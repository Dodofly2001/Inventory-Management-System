...
<head>
  ...
  <title>View Booked Product </title>
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="ViewBookedProduct.php" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">View Booked Product Detail</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item">View Booked Product Detail</li>
              <li class="breadcrumb-item active">View Booked Product Detail</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
      ...
      <div class="container-fluid">
        <div class="row">
          <div class="col-lg-12">
            <div class="card">
              <div class="card-body">
                <h5 class="card-title">View Booked Product Detail</h5>

                <p class="card-text">
                  Please view the booked product that you have made
                </p>
                <br>
                ...
                <?php
                    function checkfileupload($conn, $bookingID)
                    {
                    ...
                    function getstatus($conn, $bookingID)
                    {
                        $sql = "SELECT ProofPaymentStatus FROM proofpayment WHERE booking_ID = '".$bookingID."'";
                        $result = mysqli_query($conn,$sql);
                        $value = mysqli_fetch_assoc($result);
                        $row = mysqli_num_rows($result);
                        ...
                        if($row > 0)
                        {
                            $status = $value['ProofPaymentStatus'];
                            return $status;
                        }
                    }
                ...
                <?php 
                    ...
                    if(checkfileupload($conn, $bookingID) == true)
                    { 
                      if(getstatus($conn,$bookingID) != "Cancel")
                      {
                        $status = getstatus($conn,$bookingID);
                        
                        echo "Status : " . $status;
                        $sqltrackingnum = "SELECT TrackingNo FROM booking WHERE Booking_ID = '".$bookingID."'";
                        $result = mysqli_query($conn,$sqltrackingnum);
                        $value = mysqli_fetch_assoc($result);
                        $trackingnum = $value['TrackingNo']; 
                        
                                              
                        echo " Tracking number: <input type = 'text' value = '$trackingnum' readonly>";
                        
                       
                ?>  
                    <form action = "PupdateCancel.php" method = "POST">
                ...
                ?>
                  ...
                  Status : &nbsp; Not Complete &nbsp;&nbsp; &nbsp;
                  | &nbsp; &nbsp; &nbsp;
                  Tracking No:  &nbsp; &nbsp; <input type = "text" value = "   " readonly>
                  </p>

    
                  <form action = "PuploadProofPayment.php" method = "POST" enctype = "multipart/form-data">
                        ...
                        <br>
                        <br>
                        Please insert the value of payment: 
                        &nbsp; &nbsp;
                        <input type = "text" name = "paymentgive">
                        <br>
                        <br>
