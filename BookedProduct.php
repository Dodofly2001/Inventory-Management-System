  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Booked Product</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">Booked Product</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
      ...
      <div class="container-fluid">
        <div class="row">
          <div class="col-lg-12">
            <div class="card">
              <div class="card-body">
                <h5 class="card-title">Booked Product</h5>

                <p class="card-text">
                  Product that has been booked
                </p>
                ...
                while ($row = mysqli_fetch_assoc($result))
                {
                  ...
                  $customername = $value2['CustomerName'];

                  if(checkbookinginfo($conn,$bookingID) ==true)
                  {
                    echo "<form action = 'ViewBookedProductDetailAdmin.php' method = 'POST'>";
                    echo "<input type = 'hidden' name = 'bookingID' value = '".$bookingID."'>";
                    echo "<tr><td>".$bookingID."</td><td>".$bookingDate."</td><td>".$bookingTime."</td><td>".$customername."</td><td><input type = 'submit' value = 'Open'></td></tr>";
                    echo "</form>";
                  }
                }
                ?>
