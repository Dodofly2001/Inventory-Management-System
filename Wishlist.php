          ...
          <div class="col-lg-12">
            <div class="card">
              <div class="card-body">
                ...
                <p class="card-text">
                  Please continue to book your product
                  <?php 
                  ...
                  if(isset($_GET['action']))
                  {
                    if($_GET["action"]=="delete")
                    {
                      ...
                      {
                        if($values['product_id'] == $_POST['productID'])
                        {
                ...
                <br>
                  <table>
                    ...
                    <?php 
                        ...
                        {
                          foreach($_SESSION['newwishlist'] as $keys => $values)
                    ...
                    <tr>
                          ...
                          <td></td>
                          <td><a href = "wishlist.php?action=delete&id=<?php echo $values['product_id']; ?>"><span>Remove</span></a></td>
