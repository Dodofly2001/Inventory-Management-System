        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="UpdateProduct.php" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Update Product</p>
                </a>
              </li>
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Update Product Availability</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">Update Product Availability</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
      ...
      <div class="container-fluid">
        <div class="row">
          <div class="col-lg-12">
            <div class="card">
              <div class="card-body">
                <h5 class="card-title">Update Product Availability</h5>
                ...
                <?php 
                  ...
                  while($value = mysqli_fetch_array($result))
                  {
                    ...
                    echo "<form action = 'UpdateProductAvailability.php' method = 'POST'>";
                    echo "<input type = 'hidden' value = '".$productID."' name  = 'productID'>";
                    echo "<tr><td>".$productName."</td><td>".$productAvailability."</td><td>".$productPrice."</td><td><input type = 'submit' value = 'Open'></td></tr>";
                    echo "</form>";
                  }
                ?>
